...
$sql= "INSERT INTO usuarios(nombre,apellido,contrasena,email,celular,direccion,tipoUsuario) VALUES ('$nombre','$apellido','$contrasena','$email','$celular','$direccion','$tipoUsuario')";
