<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $mytype = mysqli_real_escape_string($db,$_POST['tipo']); 
      
      $sql = "SELECT id FROM usuarios WHERE email = '$myusername' and contrasena= '$mypassword' and tipoUsuario ='$mytype'";
        ...
        <div style = "width:300px; border: solid 1px #333333; " align = "left">
            ...
            <div style = "margin:30px">
                ...
                <form action = "" method = "post">
                  ...
                  <label>Tipo      :</label><input type = "text" name = "tipo" class = "box" /><br/><br />
